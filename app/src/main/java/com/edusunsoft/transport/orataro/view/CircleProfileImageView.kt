package com.edusunsoft.transport.orataro.view
...
class CircleProfileImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.CircleProfileImageView, defStyle, 0)

        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.CircleProfileImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor =
            a.getColor(R.styleable.CircleProfileImageView_civ_border_color, DEFAULT_BORDER_COLOR)
        mBorderOverlay =
            a.getBoolean(R.styleable.CircleProfileImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY)
        mCircleBackgroundColor = a.getColor(
            R.styleable.CircleProfileImageView_civ_circle_background_color,
    ...
    private fun inTouchableArea(x: Float, y: Float): Boolean {
        return (x - mBorderRect.centerX()).toDouble().pow(2.0) + (y - mBorderRect.centerY()).toDouble().pow(
            2.0
